...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        case TD(TD_ESC_CTRL):  // list all tap dance keycodes with tap-hold configurations
...
tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Escape, hold for Ctrl
    [TD_ESC_CTRL] = ACTION_TAP_DANCE_TAP_HOLD(KC_ESC, KC_LEFT_CTRL),
};
...
[0] = LAYOUT(
        ...
        TD(TD_ESC_CTRL),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_PGDN,
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   MO(1),
        KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,                                      KC_RGUI, MO(2),            KC_LEFT, KC_DOWN, KC_RGHT
),
[1] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MSTP,
